...
@inject
async def create_comment(commentcookie: CommentCookie, user_id: str | None= Cookie(default=None), timestamp: str | None=Cookie(default=None), comment_repo: SQLiteRepository = Depends(Provide[Container.db_manager])) -> Comment:
